...
float auto_placeCenterGoal(bool newIR)
{
    ...
    if (zone == 3){
       ...
       move_encoderortouch(267, -15, 0, Lf, Lb, Rf, Rb);
    }
    if (zone == 2){
        //Nav to zone 2
        ...
        move_encoderortouch(333, -15, 0, Lf, Lb, Rf, Rb);
        move_encoderortouch(400, -10, 0, Lf, Lb, Rf, Rb);
    ...
    if (zone == 1){
        ...
        wait1Msec(100);
        move_encoderortouch(650, -15, 0, Lf, Lb, Rf, Rb);
        wait1Msec(100);
    }
    motor[Intake] = 0;
    wait1Msec(250);
...
void auto_centerGoalToLarge(float zone){
    ...
    if (zone == 2){
        ...
        forward_encoderMecanum(5333, -50, 0, Lf, Lb, Rf, Rb);
    }
    if (zone == 1){
