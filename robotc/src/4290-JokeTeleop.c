...
task main()
{
  ...
  while (true)
  {
    ...
    //Gyro Reset Code
    if(joy1Btn(4) == 1 && !joy1Btn(5)) { gyro_reset(); }
  if(joystick.joy1_TopHat == 0) {
    ...
    if (joy1Btn(7) == 1 && !joy1Btn(5)){
      servo[GoalRetainer] = 255;
    }
    //Goal Latch Open
    if(joy1Btn(3)== 1 && joy1Btn3last != 1 && !joy1Btn(5)){
      servo[GoalRetainer] = 130;
    }
    //Goal Latch Closed
    if(joy1Btn(1)== 1 && joy1Btn1last != 1 && !joy1Btn(5)){
      servo[GoalRetainer] = 5;
    }
    ...
    if (joy1Btn(5) && deadband(k_deadband,joystick.joy1_y2) == 0){
        servo[TubeWinch] = 133;
    }
    else if (joy1Btn(5)){
      servo[TubeWinch] = (deadband(k_deadband,joystick.joy1_y2))+127;
    }

    joy1Btn1last = joy1Btn(1);
    joy1Btn2last = joy1Btn(2);
    joy1Btn3last = joy1Btn(3);
    joy1Btn4last = joy1Btn(4);
